...
url: /docs/mftcoder-quickstart
aliases:
- "/docs/mftcoder-quickstart"
---
...
🚀🚀 [**MFTCoder-accelerate: Accelerate + Deepspeed/FSDP Codebase for MFT(Multi-task Finetuning)**](/docs/mftcoder-accelerate)


If you want to explore some new framework like atorch, you could check:

🚀 [MFTCoder-atorch: Atorch Codebase for MFT(Multi-task Finetuning)](/docs/mftcoder-atorch)
