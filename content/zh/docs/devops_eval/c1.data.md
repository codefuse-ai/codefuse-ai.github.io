...
详情请参阅[tool_learning_info_zh.md](/docs/devops_eval/tool_learning_info_zh.md)。
工具学习评测过程，详情请参阅见 [tool_learning_evalution.md](/docs/devops_eval/tool_learning_evalution.md)。
<br>
