...
url: /docs/mftcoder-quickstart-zh
aliases:
- "/docs/mftcoder-quickstart-zh"
---
...
🚀🚀 [MFTCoder-accelerate: Accelerate + DeepSpeed/FSDP Codebase for MFT(Multi-task Finetuning)](/docs/mftcoder-accelerate-zh)


如果你想探索一些新兴的训练框架，可以尝试：

🚀 [MFTCoder-atorch: Atorch Codebase for MFT(Multi-task Finetuning)](/docs/mftcoder-atorch-zh)
