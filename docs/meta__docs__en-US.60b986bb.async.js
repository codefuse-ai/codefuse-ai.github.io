...
Try to use options already listed in this document. If you need to add a new option, please update this document promptly.`,paraId:10,tocIndex:8},{value:"The title should clearly explain the main content of the submission.",paraId:11,tocIndex:9},{value:"Coming soon",paraId:12,tocIndex:10},{value:"doris-commit-format",paraId:13,tocIndex:11}]},95455:function(t,e,a){a.r(e),a.d(e,{texts:function(){return n}});const n=[{value:`
  ...
  `,paraId:1},{value:"ModelScope",paraId:1},{value:`Hello World! This is CodeFuse!\r
...
for k,v in class_mds.items():
    ...
    with open(f"/home/user/code_base/docs/{k}.md", "w") as f:
        f.write(text_md)
`,paraId:14,tocIndex:7}]},12810:function(t,e,a){a.r(e),a.d(e,{texts:function(){return n}});const n=[{value:"First, add the OpenAI configuration; this could also be a model similar to the OpenAI interface (launched via fastchat).",paraId:0,tocIndex:0},{value:`import os, sys\r
\r
api_key = "sk-xxx"\r
api_base_url= "https://api.openai.com/v1"\r
embed_model = "{{embed_model_name}}"\r
embed_model_path = "{{embed_model_path}}"
`,paraId:1,tocIndex:0},{value:"Constructing with a local model file",paraId:2,tocIndex:1},{value:`from muagent.llm_models.llm_config import EmbedConfig, LLMConfig\r
\r
embed_config = EmbedConfig(\r
    embed_engine="model", embed_model=embed_model, embed_model_path=embed_model_path\r
)
`,paraId:3,tocIndex:1},{value:"Constructing via OpenAI",paraId:4,tocIndex:1},{value:`from muagent.llm_models.llm_config import EmbedConfig, LLMConfig\r
\r
embed_config = EmbedConfig(\r
    embed_engine="openai", api_key=api_key, api_base_url=api_base_url,\r
)
`,paraId:5,tocIndex:1},{value:"Customizing and inputting langchain embeddings",paraId:6,tocIndex:1},{value:`from muagent.llm_models.llm_config import EmbedConfig, LLMConfig\r
\r
...
`,paraId:7,tocIndex:1}]},41290:function(t,e,a){a.r(e),a.d(e,{texts:function(){return n}});const n=[{value:"First, add the OpenAI configuration, or you can use another model similar to the OpenAI interface (launched through fastchat).",paraId:0,tocIndex:0},{value:`import os, sys\r
\r
api_key = "sk-xxx"\r
api_base_url= "https://api.openai.com/v1"\r
model_name = "gpt-3.5-turbo"
`,paraId:1,tocIndex:0},{value:"By passing the class ",paraId:2,tocIndex:1},{value:"openai",paraId:2,tocIndex:1},{value:`from muagent.llm_models.llm_config import EmbedConfig, LLMConfig\r
\r
llm_config = LLMConfig(\r
    model_name=model_name, api_key=api_key, api_base_url=api_base_url, temperature=0.3,\r
    stop="**Observation:**"\r
)
`,paraId:3,tocIndex:1},{value:"Customizing and inputting langchain LLM",paraId:4,tocIndex:1},{value:`from muagent.llm_models.llm_config import EmbedConfig, LLMConfig\r
